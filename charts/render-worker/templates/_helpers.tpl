...
helm.sh/chart: {{ include "render-worker.chart" . }}
{{ include "render-worker.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- define "render-worker.envFrom" -}}
- configMapRef:
    name: {{ include "render-worker.fullname" . }}-configmap
{{- end }}
